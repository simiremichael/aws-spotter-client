...
import { useResetCompanyPasswordMutation } from '../services/api/propertyAPI';
...
function AdminResetPassword() {
    ...
    const [ resetCompanyPassword, {isSuccess, isLoading}] = useResetCompanyPasswordMutation();

    const handleSubmit = (e: any) => {
        e.preventDefault();
        resetCompanyPassword(formData);
    };
