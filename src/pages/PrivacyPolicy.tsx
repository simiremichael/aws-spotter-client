  ...
  return (
    <StyledBox>
        ...
        <StyledContainer>
            ...
            <Privacy>
            We take your privacy very seriously and are committed to protecting the privacy of all visitors and subscribers to our website <a href='www.propertyfinder.com'>www.propertyfinder.com</a> (the “Website”) or any application we make available via an app store (the <strong>“Application”</strong>, together with the Website, the <strong>“Platform”</strong>), and the corresponding services available through the Platform (the <strong>“Services”</strong>).
            <br/>
            <br/>
            ...
            <br/>
            <br/>
            This privacy policy: (i) applies only to the Platform and not to websites or applications of any other companies or organisations; and (ii) specifically addresses our obligations pursuant to the law of the Nigeria.
            <PrivacyTitle>The data we collect about you</PrivacyTitle>
            ...
            <br/>
            <br/>
            Calls between you and Residence Spotter, or between you and third parties made through Residence Spotter (such as real estate agents you contact about a property through a form or link on our Website, or using contact information found on our Website), may be recorded or monitored for quality assurance and customer service purposes. Residence Spotter uses a third-party service provider to track phone calls and text messages between you and real estate professionals so that we and the real estate professional can access certain details about the contact. As part of this process, Residence Spotter and its service provider will receive in real time and store data about your call or text message, including the date and time of the call or text message, your phone number, and the content of the text message.
            <br/>
            <br/>
            <PrivacyTitle>Who we share your personal information with</PrivacyTitle>
            ...
            <br/>
            <br/>
            <PrivacyTitle>Purpose of processing</PrivacyTitle>
            ...
            <br/>
            <br/>
            <PrivacyTitle>Disclosure of information</PrivacyTitle>
            ...
            <br/>
            <br/>
            <PrivacyTitle>Security measures</PrivacyTitle>
            ...
            <br/>
            <br/>
            <PrivacyTitle>Updates to policy</PrivacyTitle>
