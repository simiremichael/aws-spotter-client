 ...
 //, {refetchOnMountOrArgChange: true }
  ...
  <SplideSlide>
    <ViewImg src={img.img}/>
      ...
      <StyledContainer>
        <StyledPlink href='/buy'><Plink><Psvg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 512"><path d="M192 448c-8.188 0-16.38-3.125-22.62-9.375l-160-160c-12.5-12.5-12.5-32.75 0-45.25l160-160c12.5-12.5 32.75-12.5 45.25 0s12.5 32.75 0 45.25L77.25 256l137.4 137.4c12.5 12.5 12.5 32.75 0 45.25C208.4 444.9 200.2 448 192 448z" /></Psvg>Back</Plink></StyledPlink>
        ...
        <Grid container>
          ...
          <GridPrice item lg={4} sm={12} md={4} xs={12}>
            ...
            <ContactTopContainer>
            <Links href={`tel:${buyDetail?.phone}`}>
              <CallContainer>
                ...
                <Links href={`mailto:${buyDetail?.email}`}>
              <EmailContainer>
              ...
              <Links href={`https://wa.me/+234${buyDetail?.phone}?text=I'm%20inquiring%20about%20the%20apartment%20listing`}>
              <WhatsAppContainer>
            ...
            <Grid container>
              ...
              <Grid item lg={6} sm={6} md={6} xs={6}>
                ...
                <AgentCompany>{buyDetail?.companyName}</AgentCompany>
                 {/* @ts-ignore:next-line */}
                <AgentProperty>({totalData?.data?.filter((dat: any) => dat.creator).map((i:any) => i === buyDetail?.creator).length} properties listed)</AgentProperty>
              </Grid>
            </Grid>
          </Grid>
        </Grid>
