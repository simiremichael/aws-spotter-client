  ...
  return (
    ...
    <StyledBox>
        ...
        >
          ...
          <MenuItem value='build:desc'>Developed(earliest)</MenuItem>
          <MenuItem value='build:inc'>Developed(latest)</MenuItem>
        </Select>
        </FormControl>
          </RightContainer>
        </SortContainer>
            ...
            {rentProperty?.data.map((result: any) => ( 
              ...
              <StyledLink href={`/rentdetailsPage/${result._id}`}>
                  <LeftContainers>
                    ...
                    <Para>{!result.propertyTitle && isFetching ? <Skeleton variant="rounded" width='100%' height='40%' /> : result?.propertyTitle}</Para>
                    <BedBathContainer>
                    ...
                    <DetailContainer>
                      ...
                      <Detail>{!result.address1 && isFetching ? <Skeleton variant="rounded" width='100%' height='45%' /> : result?.address1}</Detail>
                    </DetailContainer>
                  </LeftContainers>
                  </StyledLink>
                  <RightContainers>
                    ...
                    <LogoImg src={!result.price && isFetching ? <Skeleton variant="circular" width={40} height={40} /> :result.logo} />
                  </RightContainers>
                </CardDetails>
                <BottomContainer>
