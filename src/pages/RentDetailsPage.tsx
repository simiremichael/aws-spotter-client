...
const [viewState, setViewState] = useState(initial)
  ...
  <SplideSlide>
    <ViewImg src={img.img}/>
      ...
      <StyledContainer>
        <StyledPlink href='/rent'><Plink><Psvg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 512"><path d="M192 448c-8.188 0-16.38-3.125-22.62-9.375l-160-160c-12.5-12.5-12.5-32.75 0-45.25l160-160c12.5-12.5 32.75-12.5 45.25 0s12.5 32.75 0 45.25L77.25 256l137.4 137.4c12.5 12.5 12.5 32.75 0 45.25C208.4 444.9 200.2 448 192 448z" /></Psvg>Back</Plink></StyledPlink>
        ...
        <Grid container>
          ...
          <GridPrice item lg={4} sm={12} md={4} xs={12}>
            ...
            <ContactTopContainer>
            <Links href={`tel:${rentDetail?.phone}`}>
                  <CallContainer>
              ...
              <Links href={`mailto:${rentDetail?.email}`}>
                  <EmailContainer>
                  ...
                  <Links href={`https://wa.me/+234${rentDetail?.phone}?text=I'm%20inquiring%20about%20the%20apartment%20listing`}>
                  <WhatsAppContainer>
