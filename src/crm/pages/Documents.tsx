...
function Documents() {
  ...
  return (
    ...
    <StyledContainer>
     <LeftInnerGrid item lg={2} md={2} sm={4} xs={6} >
     <LeftContainer>
       {/* @ts-ignore:next-line */}
    ...
    <Plusbutton><Span>+</Span></Plusbutton>
    </PlusTitleContainer>
    <InnerRightContainer>
      {/* <InputContainer>
   ...
   <>
    ...
    { sidebar && (
    <SideBarContainer  item lg={2} md={2} sm={4} xs={6}>
    <NavItemsContainer>
      ...
      <NavItems><NavBarLink to='/documents'><NavItemsIcon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M447.1 96h-172.1L226.7 50.75C214.7 38.74 198.5 32 181.5 32H63.1c-35.35 0-64 28.66-64 64v320c0 35.34 28.65 64 64 64h384c35.35 0 64-28.66 64-64V160C511.1 124.7 483.3 96 447.1 96zM463.1 416c0 8.824-7.178 16-16 16h-384c-8.822 0-16-7.176-16-16V96c0-8.824 7.178-16 16-16h117.5c4.273 0 8.293 1.664 11.31 4.688L255.1 144h192c8.822 0 16 7.176 16 16V416z"/></NavItemsIcon><strong>Documents</strong></NavBarLink></NavItems>
     ...
     <BodyGrid item lg={sidebar ? 10 : 12} md={sidebar ? 10 : 12} sm={sidebar ? 8 : 12} xs={sidebar ? 6 : 12}>
     { info ?
     <Grid container>
     <Grid item lg={6} md={6} sm={12} xs={12}>
     <ContactsContainer>
     <ContactsTitle>Documents</ContactsTitle>
      <ContactsContent>
      There is no way to manage a property without documents. Check out how easy it is to store, share, and get to your insurance policies, lease agreements, and other files that have to do with your property.
      </ContactsContent>
      <CreateContactsContainer>
      <CreateContacts>New Document</CreateContacts>
      </CreateContactsContainer>
     </ContactsContainer>
   </Grid>
   <Grid item lg={6} md={6} sm={12} xs={12}>
