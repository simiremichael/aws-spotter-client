  ...
  return (
   ...
   <>
    ...
    <NavItemsContainer>
      ...
      <NavItems><NavBarLink to='/reports'><NavItemsIcon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M160 80C160 53.49 181.5 32 208 32H240C266.5 32 288 53.49 288 80V432C288 458.5 266.5 480 240 480H208C181.5 480 160 458.5 160 432V80zM0 272C0 245.5 21.49 224 48 224H80C106.5 224 128 245.5 128 272V432C128 458.5 106.5 480 80 480H48C21.49 480 0 458.5 0 432V272zM400 96C426.5 96 448 117.5 448 144V432C448 458.5 426.5 480 400 480H368C341.5 480 320 458.5 320 432V144C320 117.5 341.5 96 368 96H400z"/></NavItemsIcon><strong>Reports</strong></NavBarLink></NavItems>
    </NavItemsContainer>
     </SideBarContainer>
     )}
    ...
    {/* <ReportsTitle>Reports</ReportsTitle>*/}
     ...
     <CardItemsNo>0</CardItemsNo>
     <CardPercent>0%</CardPercent>
     <CardItems>no data</CardItems>
     </ReportCard>
   </Grid>
   <Grid item lg={3} md={3} sm={6} xs={12}>
   <ReportCard>
   ...
   <Grid item lg={3} md={3} sm={6} xs={12}>
     <ReportCard>
     <CardTitle>Listings Presentation</CardTitle>
     <CardItemsNo>0</CardItemsNo>
     <CardPercent>0%</CardPercent>
     <CardItems>no data</CardItems>
     </ReportCard>
