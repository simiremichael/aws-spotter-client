  ...
  return (
   ...
   <>
    ...
    <NavItemsContainer>
     ...
     <ContactsContainer>
     <ContactsTitle>Finances</ContactsTitle>
      <ContactsContent>
      Keep all your business revenue and expenses organised in one place. Every transcation record can be related to property and customer.
      </ContactsContent>
      <CreateContactsContainer>
      <CreateContacts>New Finance record</CreateContacts>
      </CreateContactsContainer>
     </ContactsContainer>
   </Grid>
   <Grid item lg={6} md={6} sm={12} xs={12}>
