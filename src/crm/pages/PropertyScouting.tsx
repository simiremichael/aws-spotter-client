...
import { useGetScoutingsQuery, useLogoutAgentMutation } from '../../services/api/propertyAPI';
import { selectCurrentScouting, setScouting } from '../../services/features/scoutingSlice';
...
`
 ...
 const PropertyOuterBodyContainer = styled.div`
 width: 100%;
...
function PropertyScouting() {
  ...
  useEffect(() => {
   appDispatch(setScouting({scouting: data}))
  ...
  const {scouting} = useAppSelector(selectCurrentScouting)
  ...
  return (
    ...
    <RightContainer>
    <PlusTitleContainer>
    <Title>Property Scouting</Title>
    <Plusbutton onClick={handleNavigate}><AddOutlinedIcon style={{color: 'white'}}/></Plusbutton>
    </PlusTitleContainer>
    <InnerRightContainer>
      {/* <InputContainer>
   ...
   <>
    ...
    <NavItemsContainer>
      ...
      <NavItems><NavBarLink to='/propertyScouting'><NavItemsIcon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M411.4 175.5C417.4 185.4 417.5 197.7 411.8 207.8C406.2 217.8 395.5 223.1 384 223.1H192C180.5 223.1 169.8 217.8 164.2 207.8C158.5 197.7 158.6 185.4 164.6 175.5L260.6 15.54C266.3 5.897 276.8 0 288 0C299.2 0 309.7 5.898 315.4 15.54L411.4 175.5zM288 312C288 289.9 305.9 272 328 272H472C494.1 272 512 289.9 512 312V456C512 478.1 494.1 496 472 496H328C305.9 496 288 478.1 288 456V312zM0 384C0 313.3 57.31 256 128 256C198.7 256 256 313.3 256 384C256 454.7 198.7 512 128 512C57.31 512 0 454.7 0 384z"/></NavItemsIcon><strong>Property Scouting</strong></NavBarLink></NavItems>
     ...
     <ContactsContainer>
     <ContactsTitle>Property Scoutings</ContactsTitle>
      <ContactsContent>
      Using your own data find the best-suited property for your Customer. System automatically identifies the best real estate opportunities for your customer.
      </ContactsContent>
      <CreateContactsContainer>
      <CreateContacts>Create Property Scouting</CreateContacts>
      </CreateContactsContainer>
     </ContactsContainer>
   </Grid>
   <Grid item lg={6} md={6} sm={12} xs={12}>
     ...
     <Grid container>
      ...
      <InnerActivityContainer>
       <PropertDetailContainer></PropertDetailContainer>
         ...
         <Grid item lg={1.4} md={1.4} sm={1.4} xs={1.4}>
         ...
         <ActivityHeading>Description</ActivityHeading>
         <InnerActivityContainer>
         <Activityinput type='text'  />
       </InnerActivityContainer> 
         </Grid>
         <Grid item lg={1.2} md={1.2} sm={1.2} xs={1.2}>
         <ActivityHeading>category</ActivityHeading>
         <InnerActivityContainer>
          <Select>
         ...
         <InnerActivityContainer>
         <Activityinput placeholder='from' type='text'  />
         <Activityinput placeholder='to' type='text'  />
       </InnerActivityContainer> 
         </Grid>
         <Grid item lg={1.4} md={1.4} sm={1.4} xs={1.4}>
         <ActivityHeading>Budget</ActivityHeading>
         <InnerActivityContainer>
         <Activityinput placeholder='from' type='number'  />
         <Activityinput placeholder='to' type='number'  />
       </InnerActivityContainer> 
         </Grid>
         <Grid item lg={1.6} md={1.6} sm={1.6} xs={1.6}>
         <ActivityHeading>Date</ActivityHeading>
         <InnerActivityContainer>
         <Activityinput placeholder='from' type='number'  />
         <Activityinput placeholder='to' type='number'  />
       </InnerActivityContainer> 
         ...
         <BodyBottomContainer>
            {/* @ts-ignore:next-line */}
            {scouting?.data?.map((item: any) => (
         <Grid container>
       <Grid item lg={0.5} md={0.5} sm={0.5} xs={0.5} key={item._id}>
      <InnerActivityContainer>
       <PropertDetailContainer>
       ...
       <TickLabel htmlFor='ticks' ><TickSvg  xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 16 16"><path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="m2.75 8.75l3.5 3.5l7-7.5"/></TickSvg></TickLabel>
         ...
         <InnerActivityContainer>
         <PropertDetailContainer>
          <Activity>{item.location}</Activity>
         </PropertDetailContainer>
       </InnerActivityContainer> 
         </Grid>
         <Grid item lg={2.5} md={2.5} sm={2.5} xs={2.5}>
         <InnerActivityContainer>
         <PropertDetailContainer>
          <Activity>{item.description}</Activity>
         </PropertDetailContainer>
       </InnerActivityContainer> 
         </Grid>
         <Grid item lg={1.2} md={1.2} sm={1.2} xs={1.2}>
         <InnerActivityContainer>
          <PropertDetailContainer>
           <Activity>For {item.category}</Activity>
         </PropertDetailContainer>
       </InnerActivityContainer> 
         </Grid>
         <Grid item lg={1.4} md={1.4} sm={1.4} xs={1.4}>
         <InnerActivityContainer>
         <PropertDetailContainer>
           <Activity>{item.propertyType}</Activity>
         </PropertDetailContainer>
         </InnerActivityContainer> 
         </Grid>
         <Grid item lg={1.4} md={1.4} sm={1.4} xs={1.4}>
         ...
         <InnerActivityContainer>
         <PropertDetailContainer>
           <Activity>{item.createdAt}</Activity>
         </PropertDetailContainer>
         </InnerActivityContainer> 
         </Grid>
         {/* <Grid item lg={1.5} md={1.5} sm={1.5} xs={1.5}>
...
export default PropertyScouting